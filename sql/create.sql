...
ALTER SEQUENCE Pilot_id_seq RESTART WITH 250;

CREATE TABLE Flight
(
	--fnum INTEGER NOT NULL,
	fnum SERIAL NOT NULL,
...
ALTER SEQUENCE Flight_fnum_seq RESTART WITH 2010;
...
ALTER SEQUENCE Plane_id_seq RESTART WITH 70;
...
ALTER SEQUENCE Technician_id_seq RESTART WITH 250;
...
ALTER SEQUENCE Reservation_rnum_seq RESTART WITH 10000;

CREATE TABLE FlightInfo
(
	--fiid INTEGER NOT NULL,
	fiid SERIAL NOT NULL,
